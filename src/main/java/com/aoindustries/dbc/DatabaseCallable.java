...
/**
 * Target that may be used by {@link Database#transaction(com.aoindustries.dbc.DatabaseCallable)}.
 *
 * @see  Database#transaction(com.aoindustries.dbc.DatabaseCallable)
 *
